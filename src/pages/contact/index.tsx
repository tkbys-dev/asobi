        ...
        <div className={styles.main_inner_s}>
          ...
          <form>
            <div className={styles.form_wrap}>
              ...
              <div className={styles.form_input}><input type="text" name="company_name" placeholder="お名前をご入力ください" value="" /></div>
            </div>
            <div className={styles.form_wrap}>
              <div className={styles.form_label}>会社名</div>
              <div className={styles.form_input}><input type="text" name="company_name" placeholder="会社名をご入力ください" value="" /></div>
            </div>
            <div className={styles.form_wrap}>
              <div className={styles.form_label}>メールアドレス</div>
              <div className={styles.form_input}><input type="text" name="company_name" placeholder="xxx.@aaaaaaaaa.com" value="" /></div>
            </div>
            <div className={styles.form_wrap}>
              <div className={styles.form_label}>お問い合わせ内容</div>
              <div className={styles.form_input}><textarea name="company_name" placeholder="お問い合わせの詳細を1,000文字以内でご入力ください" value="" /></div>
            </div>
            <div className={styles.form_accept}><input type="checkbox" /><span>個人情報の取り扱いに同意します。</span></div>
